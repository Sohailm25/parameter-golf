...
- test-time adaptation that is document-local, reset correctly, and clearly described
...
4. whether the same method would generalize to a hidden held-out split
