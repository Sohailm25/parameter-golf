...
- Source queries: `dynamic evaluation transformer language model`, `"dynamic evaluation" transformer language model`
- Local PDF: `background-work/papers/files/arxiv/1904.08378v1.pdf`
- Local text: `background-work/papers/files/arxiv_text/1904.08378v1.txt`
