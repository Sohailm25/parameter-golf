...
- URL: https://arxiv.org/abs/2201.12469v1
- Authors: Minjia Zhang, Niranjan Uma Naresh, Yuxiong He
- Updated: `2022-01-29T01:47:01Z`
- Categories: `cs.LG`, `cs.CL`
- Source queries: `"large batch" language model optimization`
- Local PDF: `background-work/papers/files/arxiv/2201.12469v1.pdf`
- Local text: `background-work/papers/files/arxiv_text/2201.12469v1.txt`
